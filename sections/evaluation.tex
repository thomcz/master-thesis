...
\center
  ...
  \caption{Latenz der einzelnen Nachrichten aus Interaktion 1 und die Vorhersage aus der Performance-Analyse.}
...
\begin{table}
  ...
  \end{tabular}
	\caption{\label{tab:interaction1error} Fehler für Interaktion 1}
\end{table}
