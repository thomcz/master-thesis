...
MOMs unterscheiden sich, neben ihrer Implementierung, in ihrer Architektur. Es gibt drei verschiedene Architekturen für MOMs (TODO ref).
\begin{itemize}
...
Der Interaktionstyp einer MOM gibt an, wie viele Sender und Empfänger an einer Komunikation teilnehmen können. Dabei wird zwischen den Folgenden Typen unterschieden (TODO ref):
\begin{itemize}
...
\end{itemize}
In Palladio ist es möglich Fehlerwahrscheinlichkeiten an Komponenten und Ressourcen zu annotieren. Im Rahmen der Masterarbeit wird dieses Qualitätsattribut nicht betrachtet.
